...
export default function GisNavbar() {
    ...
    return (
        <nav className="w-full h-16 px-6 flex items-center justify-between bg-white border-b border-slate-200/80 text-slate-800 select-none">
            ...
            <div className="hidden md:flex flex-1 max-w-lg mx-8 relative">
                <form onSubmit={handleSearchSubmit} className="w-full relative group">
                    ...
                    <input
                        ...
                        className="w-full bg-slate-50 border border-slate-200/80 py-2.5 pl-12 pr-6 text-xs text-slate-800 placeholder:text-slate-400 focus:outline-none focus:border-[#2563eb] focus:bg-white transition-all rounded-none"
                    />
                </form>
            </div>
            ...
            <div className="flex items-center gap-4">
                ...
                <button
                    ...
                    disabled={isSyncing}
                    className="flex items-center gap-2 px-3 py-2 text-slate-500 hover:text-slate-800 hover:bg-slate-50 transition-all rounded-none outline-none"
                ...
                <button
                    ...
                    className={`flex items-center gap-2 px-3 py-2 transition-all rounded-none outline-none ${isCopied ? 'text-[#2563eb]' : 'text-slate-500 hover:text-slate-800 hover:bg-slate-50'}`}
                ...
                <div className="flex items-center gap-3 pl-2">
                    ...
                    <div className="w-9 h-9 bg-blue-50 text-[#2563eb] flex items-center justify-center text-xs font-black border-2 border-blue-100 rounded-none shrink-0 shadow-inner">
                        <User size={16} />
                    </div>
                </div>
