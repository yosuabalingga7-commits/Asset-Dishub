        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1 space-y-6">
                <div class="bg-[#0B2A4A] rounded-[2.5rem] p-8 text-white shadow-2xl relative overflow-hidden">
                    <p class="text-[10px] font-black text-white/40 uppercase tracking-[0.2em] mb-6">Dokumentasi Laporan</p>
                    ...
                    <div class="space-y-4">
                        <div class="relative group">
                            ...
                            @else
                                <div class="w-full h-32 bg-white/5 rounded-2xl border border-dashed border-white/20 flex items-center justify-center mb-4">
                                    <span class="text-[10px] text-white/30 uppercase font-bold text-center px-4">Foto Tidak Tersedia</span>
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="p-4 bg-white/5 rounded-2xl border border-white/10">
                            ...
                            <a href="https://www.google.com/maps?q={{ $lat }},{{ $lng }}" target="_blank" 
                               class="text-[9px] bg-blue-500 hover:bg-blue-600 px-3 py-1 rounded-md text-white font-black uppercase transition-all inline-block">
                ...
                @if(session('success'))
                <div class="bg-emerald-50 border border-emerald-200 text-emerald-700 p-4 rounded-2xl text-[11px] font-bold uppercase tracking-tight">
                ...
                <div class="bg-white border border-slate-200 rounded-[2.5rem] p-10 shadow-sm">
                    <div class="flex items-center justify-between mb-8 pb-6 border-b border-slate-100">
                        <div>
                            ...
                            <p class="text-sm font-black text-[#0B2A4A] uppercase italic">
                                👤 {{ $ticket->user->name ?? 'Belum Ditentukan' }}
                            </p>
                        </div>
                        <div class="text-right">
                            <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Target Selesai</p>
                            <p class="text-sm font-black text-rose-500 uppercase">
                    ...
                    <div class="mb-8">
                        <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Prioritas Kerja</p>
                        <div class="flex items-center gap-2">
                            ...
                            @endphp
                            <span class="px-4 py-1.5 rounded-lg border {{ $prioStyle }} text-[10px] font-black uppercase tracking-tighter">
                    ...
                    <div class="mb-10 pt-6 border-t border-dashed border-slate-200">
                        ...
                        <a href="{{ $waEncoded }}" target="_blank" 
                           class="w-full bg-[#25D366] hover:bg-[#128C7E] text-white font-black uppercase text-[11px] py-4 rounded-xl shadow-lg transition-all tracking-widest flex items-center justify-center gap-3">
                    ...
                    <div class="pt-8 border-t border-slate-100">
                        <div class="flex items-center justify-between mb-6">
                            <p class="text-[11px] font-black text-[#0B2A4A] uppercase tracking-widest flex items-center gap-2">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="bg-emerald-50 p-6 rounded-2xl border border-emerald-100">
                                <p class="text-[9px] font-black text-emerald-600 uppercase mb-2">Catatan Teknisi:</p>
