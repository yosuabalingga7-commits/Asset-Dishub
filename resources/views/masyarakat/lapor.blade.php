    ...
    <div class="max-w-2xl mx-auto -mt-12 relative z-20 px-4">
        ...
        <form action="{{ route('lapor.store') }}" method="POST" enctype="multipart/form-data" id="laporanForm">
            ...
            <div class="bg-white rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.3)] p-8 md:p-12 border-b-8 border-[#F4B400] text-[#1E293B]">
                ...
                {{-- SECTION MAPS (SETELAH DATA DIRI, SEBELUM DETAIL KERUSAKAN) --}}
                <div class="mb-12">
                    <div class="flex items-center gap-4 mb-8">
                ...
                <div class="mb-10">
                    ...
                    <div class="space-y-6">
                        {{-- INPUT ASET YANG DILAPORKAN DIHAPUS --}}
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="custom-dropdown" id="kondisiDropdown">
                                ...
                                <div class="dropdown-options" id="kondisiOptions">
                                    ...
                                    <div class="dropdown-option" data-value="hilang" onclick="selectKondisi('hilang', 'HILANG / DICURI', 'fa-ban')">
                                        <i class="fas fa-ban"></i>
                                        <span>HILANG / DICURI</span>
                                    </div>
                                    <div class="dropdown-option" data-value="pindah" onclick="selectKondisi('pindah', 'PINDAH POSISI', 'fa-location-dot')">
...
<script>
    ...
    // Peta CartoDB Voyager (Light Mode - Tanpa POI Kafe/Warung)
    ...
    async function cariAsetTerdekat(lat, lng) {
        ...
        try {
            ...
            // Tambahkan marker untuk setiap aset
            daftarAset.forEach(aset => {
                ...
                m.bindPopup(`
                    <div style="min-width: 200px; padding: 8px;">
                        ...
                        <button type="button" onclick="pilihAset(${aset.id}, '${aset.id_asset}', '${aset.nama.replace(/'/g, "\\'")}')" 
                ...
                // Simpan referensi popup untuk ditutup nanti
            ...
            if (daftarAset.length > 0) {
                ...
                daftarAset.forEach(aset => {
                    optionsHtml += `
                        <div class="asset-dropdown-option" onclick="pilihAset(${aset.id}, '${aset.id_asset}', '${aset.nama.replace(/'/g, "\\'")}')">
    ...
    async function updatePosition(lat, lng) {
        ...
        // Cari aset terdekat setelah update posisi
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        // Tombol toggle kunci lokasi (satu tombol untuk kunci dan buka kunci)
        ...
        toggleBtn.addEventListener('click', function() {
            if (alamatTerkunci) {
                ...
                // Jika tidak terkunci, kunci lokasi
